...
var D3 = async () => {
  const { createAppKit: s } = await import("./core-525GGI6U.js");
  return s;
};
...
function G3(s) {
  ...
  const c4 = { chains: t, methods: n2 || f5, events: a2 || C5, rpcMap: v4({}, t.length ? { [I3(t)]: u3[I3(t)] } : {}) }, l4 = a2 == null ? void 0 : a2.filter((d3) => !C5.includes(d3)), r2 = n2 == null ? void 0 : n2.filter((d3) => !f5.includes(d3));
...
var b4 = class _b {
  ...
  getRpcConfig(t) {
    ...
    const u3 = i3.length ? (t == null ? void 0 : t.methods) || f5 : [], c4 = i3.length ? (t == null ? void 0 : t.events) || C5 : [], l4 = (t == null ? void 0 : t.optionalMethods) || [], r2 = (t == null ? void 0 : t.optionalEvents) || [], m2 = (t == null ? void 0 : t.rpcMap) || this.buildRpcMap(o2, t.projectId), h4 = (t == null ? void 0 : t.qrModalOptions) || void 0;
