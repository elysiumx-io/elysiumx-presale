...
function __spreadArrays() {
  ...
  for (var r3 = Array(s3), k3 = 0, i3 = 0; i3 < il; i3++)
    for (var a2 = arguments[i3], j2 = 0, jl = a2.length; j2 < jl; j2++, k3++)
      r3[k3] = a2[j2];
  return r3;
}
function __await(v3) {
...
function Cn(t, e2, n4, r3) {
  ...
  const o4 = BigInt(32), s3 = BigInt(4294967295), a2 = Number(n4 >> o4 & s3), u = Number(n4 & s3), i3 = r3 ? 4 : 0, D = r3 ? 0 : 4;
...
var An = class extends xn {
  ...
  digestInto(e2) {
    ...
    for (let l4 = a2; l4 < o4; l4++) n4[l4] = 0;
    ...
    const D = i3 / 4, c3 = this.get();
    if (D > c3.length) throw new Error("_sha2: outputLen bigger than state");
    for (let l4 = 0; l4 < D; l4++) u.setUint32(4 * l4, c3[l4], s3);
  }
  digest() {
...
var Jn = class extends An {
  ...
  get() {
    const { Ah: e2, Al: n4, Bh: r3, Bl: o4, Ch: s3, Cl: a2, Dh: u, Dl: i3, Eh: D, El: c3, Fh: l4, Fl: p2, Gh: w3, Gl: h3, Hh: g3, Hl: S2 } = this;
    return [e2, n4, r3, o4, s3, a2, u, i3, D, c3, l4, p2, w3, h3, g3, S2];
  }
  set(e2, n4, r3, o4, s3, a2, u, i3, D, c3, l4, p2, w3, h3, g3, S2) {
    this.Ah = e2 | 0, this.Al = n4 | 0, this.Bh = r3 | 0, this.Bl = o4 | 0, this.Ch = s3 | 0, this.Cl = a2 | 0, this.Dh = u | 0, this.Dl = i3 | 0, this.Eh = D | 0, this.El = c3 | 0, this.Fh = l4 | 0, this.Fl = p2 | 0, this.Gh = w3 | 0, this.Gl = h3 | 0, this.Hh = g3 | 0, this.Hl = S2 | 0;
  }
  process(e2, n4) {
    for (let d3 = 0; d3 < 16; d3++, n4 += 4) P[d3] = e2.getUint32(n4), Q[d3] = e2.getUint32(n4 += 4);
    for (let d3 = 16; d3 < 80; d3++) {
      const m2 = P[d3 - 15] | 0, F = Q[d3 - 15] | 0, q = x2.rotrSH(m2, F, 1) ^ x2.rotrSH(m2, F, 8) ^ x2.shrSH(m2, F, 7), z2 = x2.rotrSL(m2, F, 1) ^ x2.rotrSL(m2, F, 8) ^ x2.shrSL(m2, F, 7), I2 = P[d3 - 2] | 0, O2 = Q[d3 - 2] | 0, ot = x2.rotrSH(I2, O2, 19) ^ x2.rotrBH(I2, O2, 61) ^ x2.shrSH(I2, O2, 6), tt = x2.rotrSL(I2, O2, 19) ^ x2.rotrBL(I2, O2, 61) ^ x2.shrSL(I2, O2, 6), st = x2.add4L(z2, tt, Q[d3 - 7], Q[d3 - 16]), at = x2.add4H(st, q, ot, P[d3 - 7], P[d3 - 16]);
      P[d3] = at | 0, Q[d3] = st | 0;
    }
    let { Ah: r3, Al: o4, Bh: s3, Bl: a2, Ch: u, Cl: i3, Dh: D, Dl: c3, Eh: l4, El: p2, Fh: w3, Fl: h3, Gh: g3, Gl: S2, Hh: v3, Hl: L2 } = this;
    for (let d3 = 0; d3 < 80; d3++) {
      const m2 = x2.rotrSH(l4, p2, 14) ^ x2.rotrSH(l4, p2, 18) ^ x2.rotrBH(l4, p2, 41), F = x2.rotrSL(l4, p2, 14) ^ x2.rotrSL(l4, p2, 18) ^ x2.rotrBL(l4, p2, 41), q = l4 & w3 ^ ~l4 & g3, z2 = p2 & h3 ^ ~p2 & S2, I2 = x2.add5L(L2, F, z2, Yn[d3], Q[d3]), O2 = x2.add5H(I2, v3, m2, q, Vn[d3], P[d3]), ot = I2 | 0, tt = x2.rotrSH(r3, o4, 28) ^ x2.rotrBH(r3, o4, 34) ^ x2.rotrBH(r3, o4, 39), st = x2.rotrSL(r3, o4, 28) ^ x2.rotrBL(r3, o4, 34) ^ x2.rotrBL(r3, o4, 39), at = r3 & s3 ^ r3 & u ^ s3 & u, Ct = o4 & a2 ^ o4 & i3 ^ a2 & i3;
      v3 = g3 | 0, L2 = S2 | 0, g3 = w3 | 0, S2 = h3 | 0, w3 = l4 | 0, h3 = p2 | 0, { h: l4, l: p2 } = x2.add(D | 0, c3 | 0, O2 | 0, ot | 0), D = u | 0, c3 = i3 | 0, u = s3 | 0, i3 = a2 | 0, s3 = r3 | 0, a2 = o4 | 0;
      const At = x2.add3L(ot, st, Ct);
      r3 = x2.add3H(At, O2, tt, at), o4 = At | 0;
    }
    ({ h: r3, l: o4 } = x2.add(this.Ah | 0, this.Al | 0, r3 | 0, o4 | 0)), { h: s3, l: a2 } = x2.add(this.Bh | 0, this.Bl | 0, s3 | 0, a2 | 0), { h: u, l: i3 } = x2.add(this.Ch | 0, this.Cl | 0, u | 0, i3 | 0), { h: D, l: c3 } = x2.add(this.Dh | 0, this.Dl | 0, D | 0, c3 | 0), { h: l4, l: p2 } = x2.add(this.Eh | 0, this.El | 0, l4 | 0, p2 | 0), { h: w3, l: h3 } = x2.add(this.Fh | 0, this.Fl | 0, w3 | 0, h3 | 0), { h: g3, l: S2 } = x2.add(this.Gh | 0, this.Gl | 0, g3 | 0, S2 | 0), { h: v3, l: L2 } = x2.add(this.Hh | 0, this.Hl | 0, v3 | 0, L2 | 0), this.set(r3, o4, s3, a2, u, i3, D, c3, l4, p2, w3, h3, g3, S2, v3, L2);
  }
  roundClean() {
    P.fill(0), Q.fill(0);
  }
...
function Ae(t, e2) {
  ...
  for (; n4 !== M; ) {
    const u = r3 / n4, i3 = r3 % n4, D = o4 - s3 * u;
    r3 = n4, n4 = i3, o4 = s3, s3 = D;
  }
...
function sr(t) {
  ...
  if (r3 === 1) {
    ...
    return function(i3, D) {
      const c3 = i3.pow(D, a2);
      if (!i3.eql(i3.sqr(c3), D)) throw new Error("Cannot find square root");
      return c3;
    };
  }
  const s3 = (n4 + N) / nt;
  return function(u, i3) {
    ...
    let D = r3, c3 = u.pow(u.mul(u.ONE, o4), n4), l4 = u.pow(i3, s3), p2 = u.pow(i3, n4);
    for (; !u.eql(p2, u.ONE); ) {
      if (u.eql(p2, u.ZERO)) return u.ZERO;
      let w3 = 1;
      for (let g3 = u.sqr(p2); w3 < D && !u.eql(g3, u.ONE); w3++) g3 = u.sqr(g3);
      const h3 = u.pow(c3, N << BigInt(D - w3 - 1));
      c3 = u.sqr(h3), l4 = u.mul(l4, h3), p2 = u.mul(p2, c3), D = w3;
    }
    return l4;
  };
}
function ir(t) {
  ...
  if (t % Ce === Be) {
    const e2 = (t - Be) / Ce;
    return function(r3, o4) {
      const s3 = r3.mul(o4, nt), a2 = r3.pow(s3, e2), u = r3.mul(o4, a2), i3 = r3.mul(r3.mul(u, nt), a2), D = r3.mul(u, r3.sub(i3, r3.ONE));
      if (!r3.eql(r3.sqr(D), o4)) throw new Error("Cannot find square root");
      return D;
    };
  }
  return sr(t);
...
function _e(t, e2, n4 = false, r3 = {}) {
  ...
  const u = Object.freeze({ ORDER: t, isLE: n4, BITS: o4, BYTES: s3, MASK: er(o4), ZERO: M, ONE: N, create: (i3) => H(i3, t), isValid: (i3) => {
    ...
    return M <= i3 && i3 < t;
  }, is0: (i3) => i3 === M, isOdd: (i3) => (i3 & N) === N, neg: (i3) => H(-i3, t), eql: (i3, D) => i3 === D, sqr: (i3) => H(i3 * i3, t), add: (i3, D) => H(i3 + D, t), sub: (i3, D) => H(i3 - D, t), mul: (i3, D) => H(i3 * D, t), pow: (i3, D) => fr(u, i3, D), div: (i3, D) => H(i3 * Ae(D, t), t), sqrN: (i3) => i3 * i3, addN: (i3, D) => i3 + D, subN: (i3, D) => i3 - D, mulN: (i3, D) => i3 * D, inv: (i3) => Ae(i3, t), sqrt: r3.sqrt || ((i3) => (a2 || (a2 = ir(t)), a2(u, i3))), invertBatch: (i3) => Dr(u, i3), cmov: (i3, D, c3) => c3 ? D : i3, toBytes: (i3) => n4 ? Nt(i3, s3) : ge(i3, s3), fromBytes: (i3) => {
...
function lr(t, e2) {
  return { constTimeNegate: zt, hasPrecomputes(n4) {
    ...
    for (let D = 0; D < o4; D++) {
      i3 = u, a2.push(i3);
      for (let c3 = 1; c3 < s3; c3++) i3 = i3.add(u), a2.push(i3);
      u = i3.double();
    }
    return a2;
  }, wNAF(n4, r3, o4) {
    ...
    const D = BigInt(2 ** n4 - 1), c3 = 2 ** n4, l4 = BigInt(n4);
    for (let p2 = 0; p2 < s3; p2++) {
      const w3 = p2 * a2;
      let h3 = Number(o4 & D);
      o4 >>= l4, h3 > a2 && (h3 -= c3, o4 += gt);
      const g3 = w3, S2 = w3 + Math.abs(h3) - 1, v3 = p2 % 2 !== 0, L2 = h3 < 0;
      h3 === 0 ? i3 = i3.add(zt(v3, r3[g3])) : u = u.add(zt(L2, r3[S2]));
    }
    return { p: u, f: i3 };
  }, wNAFUnsafe(n4, r3, o4, s3 = t.ZERO) {
    const { windows: a2, windowSize: u } = Mt(n4, e2), i3 = BigInt(2 ** n4 - 1), D = 2 ** n4, c3 = BigInt(n4);
    for (let l4 = 0; l4 < a2; l4++) {
      const p2 = l4 * u;
      if (o4 === Se) break;
      let w3 = Number(o4 & i3);
      if (o4 >>= c3, w3 > u && (w3 -= D, o4 += gt), w3 === 0) continue;
      let h3 = r3[p2 + Math.abs(w3) - 1];
      w3 < 0 && (h3 = h3.negate()), s3 = s3.add(h3);
    }
    return s3;
...
function br(t, e2, n4, r3) {
  ...
  const o4 = t.ZERO, s3 = tr(BigInt(n4.length)), a2 = s3 > 12 ? s3 - 3 : s3 > 4 ? s3 - 2 : s3 ? 2 : 1, u = (1 << a2) - 1, i3 = new Array(u + 1).fill(o4), D = Math.floor((e2.BITS - 1) / a2) * a2;
  let c3 = o4;
  for (let l4 = D; l4 >= 0; l4 -= a2) {
    i3.fill(o4);
    for (let w3 = 0; w3 < r3.length; w3++) {
      const h3 = r3[w3], g3 = Number(h3 >> BigInt(l4) & BigInt(u));
      i3[g3] = i3[g3].add(n4[w3]);
    }
    let p2 = o4;
    for (let w3 = i3.length - 1, h3 = o4; w3 > 0; w3--) h3 = h3.add(i3[w3]), p2 = p2.add(h3);
...
function yr(t) {
  const e2 = gr(t), { Fp: n4, n: r3, prehash: o4, hash: s3, randomBytes: a2, nByteLength: u, h: i3 } = e2, D = yt << BigInt(u * 8) - j, c3 = n4.create, l4 = _e(e2.n, e2.nBitLength), p2 = e2.uvRatio || ((y2, f3) => {
    try {
      return { isValid: true, value: n4.sqrt(y2 * n4.inv(f3)) };
    } catch {
      return { isValid: false, value: G };
    }
  }), w3 = e2.adjustScalarBytes || ((y2) => y2), h3 = e2.domain || ((y2, f3, b3) => {
  ...
  const v3 = xe((y2, f3) => {
    const { ex: b3, ey: E2, ez: B2 } = y2, C3 = y2.is0();
    f3 == null && (f3 = C3 ? wr : n4.inv(B2));
    const A2 = c3(b3 * f3), U2 = c3(E2 * f3), _2 = c3(B2 * f3);
    ...
    const { ex: E2, ey: B2, ez: C3, et: A2 } = y2, U2 = c3(E2 * E2), _2 = c3(B2 * B2), T2 = c3(C3 * C3), $ = c3(T2 * T2), R = c3(U2 * f3), V = c3(T2 * c3(R + _2)), Y = c3($ + c3(b3 * c3(U2 * _2)));
    if (V !== Y) throw new Error("bad point: equation left != right (1)");
    const Z = c3(E2 * B2), X = c3(C3 * A2);
    if (Z !== X) throw new Error("bad point: equation left != right (2)");
    return true;
  });
  class d3 {
    constructor(f3, b3, E2, B2) {
      this.ex = f3, this.ey = b3, this.ez = E2, this.et = B2, g3("x", f3), g3("y", b3), g3("z", E2), g3("t", B2), Object.freeze(this);
    }
    get x() {
    ...
    static fromAffine(f3) {
      ...
      const { x: b3, y: E2 } = f3 || {};
      return g3("x", b3), g3("y", E2), new d3(b3, E2, j, c3(b3 * E2));
    }
    static normalizeZ(f3) {
      const b3 = n4.invertBatch(f3.map((E2) => E2.ez));
      return f3.map((E2, B2) => E2.toAffine(b3[B2])).map(d3.fromAffine);
    }
    static msm(f3, b3) {
      return br(d3, l4, f3, b3);
    }
    _setWindowSize(f3) {
    ...
    equals(f3) {
      S2(f3);
      const { ex: b3, ey: E2, ez: B2 } = this, { ex: C3, ey: A2, ez: U2 } = f3, _2 = c3(b3 * U2), T2 = c3(C3 * B2), $ = c3(E2 * U2), R = c3(A2 * B2);
      return _2 === T2 && $ === R;
    }
    is0() {
    ...
    double() {
      const { a: f3 } = e2, { ex: b3, ey: E2, ez: B2 } = this, C3 = c3(b3 * b3), A2 = c3(E2 * E2), U2 = c3(yt * c3(B2 * B2)), _2 = c3(f3 * C3), T2 = b3 + E2, $ = c3(c3(T2 * T2) - C3 - A2), R = _2 + A2, V = R - U2, Y = _2 - A2, Z = c3($ * V), X = c3(R * Y), et = c3($ * Y), pt = c3(V * R);
      return new d3(Z, X, pt, et);
    }
    add(f3) {
      S2(f3);
      const { a: b3, d: E2 } = e2, { ex: B2, ey: C3, ez: A2, et: U2 } = this, { ex: _2, ey: T2, ez: $, et: R } = f3;
      if (b3 === BigInt(-1)) {
        const re = c3((C3 - B2) * (T2 + _2)), oe = c3((C3 + B2) * (T2 - _2)), mt = c3(oe - re);
      ...
      const V = c3(B2 * _2), Y = c3(C3 * T2), Z = c3(U2 * E2 * R), X = c3(A2 * $), et = c3((B2 + C3) * (_2 + T2) - V - Y), pt = X - Z, ee = X + Z, ne = c3(Y - b3 * V), un = c3(et * pt), cn = c3(ee * ne), an = c3(et * ne), fn = c3(pt * ee);
    ...
    multiply(f3) {
      const b3 = f3;
      ft("scalar", b3, j, r3);
      const { p: E2, f: B2 } = this.wNAF(b3);
      return d3.normalizeZ([E2, B2])[0];
    }
    multiplyUnsafe(f3, b3 = d3.ZERO) {
      const E2 = f3;
      return ft("scalar", E2, G, r3), E2 === G ? F : this.is0() || E2 === j ? this : q.wNAFCachedUnsafe(this, E2, d3.normalizeZ, b3);
    }
    isSmallOrder() {
    ...
    static fromHex(f3, b3 = false) {
      const { d: E2, a: B2 } = e2, C3 = n4.BYTES;
      f3 = W("pointHex", f3, C3), Tt("zip215", b3);
      const A2 = f3.slice(), U2 = f3[C3 - 1];
      A2[C3 - 1] = U2 & -129;
      const _2 = Et(A2), T2 = b3 ? D : n4.ORDER;
      ft("pointHex.y", _2, G, T2);
      const $ = c3(_2 * _2), R = c3($ - j), V = c3(E2 * $ - B2);
    ...
    toRawBytes() {
      const { x: f3, y: b3 } = this.toAffine(), E2 = Nt(b3, n4.BYTES);
  ...
  function O2(y2) {
    ...
    const b3 = W("hashed private key", s3(y2), 2 * f3), E2 = w3(b3.slice(0, f3)), B2 = b3.slice(f3, 2 * f3), C3 = I2(E2), A2 = m2.multiply(C3), U2 = A2.toRawBytes();
  ...
  function tt(y2 = new Uint8Array(), ...f3) {
    const b3 = ye(...f3);
    return I2(s3(h3(b3, W("context", y2), !!o4)));
  }
  function st(y2, f3, b3 = {}) {
    y2 = W("message", y2), o4 && (y2 = o4(y2));
    const { prefix: E2, scalar: B2, pointBytes: C3 } = O2(f3), A2 = tt(b3.context, E2, y2), U2 = m2.multiply(A2).toRawBytes(), _2 = tt(b3.context, U2, C3, y2), T2 = z2(A2 + _2 * B2);
    ft("signature.s", T2, G, r3);
    const $ = ye(U2, Nt(T2, n4.BYTES));
    return W("result", $, n4.BYTES * 2);
  }
  const at = Er;
  function Ct(y2, f3, b3, E2 = at) {
    const { context: B2, zip215: C3 } = E2, A2 = n4.BYTES;
    y2 = W("signature", y2, 2 * A2), f3 = W("message", f3), b3 = W("publicKey", b3, A2), C3 !== void 0 && Tt("zip215", C3), o4 && (f3 = o4(f3));
    const U2 = Et(y2.slice(A2, 2 * A2));
    let _2, T2, $;
    try {
      _2 = d3.fromHex(b3, C3), T2 = d3.fromHex(y2.slice(0, A2), C3), $ = m2.multiplyUnsafe(U2);
    } catch {
      return false;
    }
    if (!C3 && _2.isSmallOrder()) return false;
    const R = tt(B2, T2.toRawBytes(), _2.toRawBytes(), f3);
    return T2.add(_2.multiplyUnsafe(R)).subtract($).clearCofactor().equals(d3.ZERO);
  }
  return m2._setWindowSize(8), { CURVE: e2, getPublicKey: ot, sign: st, verify: Ct, ExtendedPoint: d3, utils: { getExtendedPublicKey: O2, randomPrivateKey: () => a2(n4.BYTES), precompute(y2 = 8, f3 = d3.BASE) {
...
var Cr = BigInt(8);
function Ar(t) {
  const e2 = BigInt(10), n4 = BigInt(20), r3 = BigInt(40), o4 = BigInt(80), s3 = kt, u = t * t % s3 * t % s3, i3 = J(u, Te, s3) * u % s3, D = J(i3, xr, s3) * t % s3, c3 = J(D, Br, s3) * D % s3, l4 = J(c3, e2, s3) * c3 % s3, p2 = J(l4, n4, s3) * l4 % s3, w3 = J(p2, r3, s3) * p2 % s3, h3 = J(w3, o4, s3) * w3 % s3, g3 = J(h3, o4, s3) * w3 % s3, S2 = J(g3, e2, s3) * c3 % s3;
...
function _r(t, e2) {
  ...
  let a2 = H(t * r3 * s3, n4);
  const u = H(e2 * a2 * a2, n4), i3 = a2, D = H(a2 * Ue, n4), c3 = u === t, l4 = u === H(-t, n4), p2 = u === H(-t * Ue, n4);
  return c3 && (a2 = i3), (l4 || p2) && (a2 = D), ur(a2, n4) && (a2 = H(-a2, n4)), { isValid: c3 || l4, value: a2 };
}
...
function Ir(t, e2) {
  ...
  var u = t.length, i3 = t.charAt(0), D = Math.log(u) / Math.log(256), c3 = Math.log(256) / Math.log(u);
  function l4(h3) {
    ...
    for (var g3 = 0, S2 = 0, v3 = 0, L2 = h3.length; v3 !== L2 && h3[v3] === 0; ) v3++, g3++;
    for (var d3 = (L2 - v3) * c3 + 1 >>> 0, m2 = new Uint8Array(d3); v3 !== L2; ) {
      for (var F = h3[v3], q = 0, z2 = d3 - 1; (F !== 0 || q < S2) && z2 !== -1; z2--, q++) F += 256 * m2[z2] >>> 0, m2[z2] = F % u >>> 0, F = F / u >>> 0;
      if (F !== 0) throw new Error("Non-zero carry");
      S2 = q, v3++;
    }
    for (var I2 = d3 - S2; I2 !== d3 && m2[I2] === 0; ) I2++;
    for (var O2 = i3.repeat(g3); I2 < d3; ++I2) O2 += t.charAt(m2[I2]);
    return O2;
  }
  function p2(h3) {
    ...
    var g3 = 0;
    if (h3[g3] !== " ") {
      for (var S2 = 0, v3 = 0; h3[g3] === i3; ) S2++, g3++;
      for (var L2 = (h3.length - g3) * D + 1 >>> 0, d3 = new Uint8Array(L2); h3[g3]; ) {
        var m2 = n4[h3.charCodeAt(g3)];
        if (m2 === 255) return;
      ...
      if (h3[g3] !== " ") {
        ...
        for (var I2 = new Uint8Array(S2 + (L2 - z2)), O2 = S2; z2 !== L2; ) I2[O2++] = d3[z2++];
        return I2;
      }
    }
  }
...
var Mr = (t, e2, n4, r3) => {
  ...
  let u = 0, i3 = 0, D = 0;
  for (let c3 = 0; c3 < s3; ++c3) {
    const l4 = o4[t[c3]];
    if (l4 === void 0) throw new SyntaxError(`Non-${r3} character`);
    i3 = i3 << n4 | l4, u += n4, u >= 8 && (u -= 8, a2[D++] = 255 & i3 >> u);
  }
...
async function Qo(t, e2, n4, r3, o4 = (0, import_time.fromMiliseconds)(Date.now())) {
  const s3 = { alg: jt, typ: Zt }, a2 = Qe(r3.publicKey), u = o4 + n4, i3 = { iss: a2, sub: t, aud: e2, iat: o4, exp: u }, D = rn({ header: s3, payload: i3 }), c3 = Rt.sign(D, r3.secretKey.slice(0, 32));
  return on({ header: s3, payload: i3, signature: c3 });
}

// node_modules/detect-browser/es/index.js
var __spreadArray = function(to2, from3, pack) {
  if (pack || arguments.length === 2) for (var i3 = 0, l4 = from3.length, ar2; i3 < l4; i3++) {
    if (ar2 || !(i3 in from3)) {
...
var alphabetBytesToChars = alphabet.reduce((p2, c3, i3) => {
  p2[i3] = c3;
  return p2;
}, []);
var alphabetCharsToBytes = alphabet.reduce((p2, c3, i3) => {
  p2[c3.codePointAt(0)] = i3;
  return p2;
}, []);
...
*/
//# sourceMappingURL=chunk-QEJAXTE2.js.map
