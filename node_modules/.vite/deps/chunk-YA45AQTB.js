import {
  ...
  fromString,
  toString
} from "./chunk-7DRZCSYY.js";
import {
  HashMD
} from "./chunk-OEJISCI5.js";
import {
  LruMap,
  checksumAddress,
  defineFormatter,
...
async function recoverPublicKey({ hash, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-OFQVSYFO.js");
  const signature_ = (() => {
...
function Chi(a2, b4, c5) {
  return a2 & b4 ^ ~a2 & c5;
}
function Maj(a2, b4, c5) {
  return a2 & b4 ^ a2 & c5 ^ b4 & c5;
}
...
var SHA1 = class extends HashMD2 {
  ...
  get() {
    const { A: A4, B: B3, C: C5, D: D3, E: E6 } = this;
    return [A4, B3, C5, D3, E6];
  }
  set(A4, B3, C5, D3, E6) {
    this.A = A4 | 0;
    this.B = B3 | 0;
  ...
  process(view, offset) {
    ...
    let { A: A4, B: B3, C: C5, D: D3, E: E6 } = this;
    for (let i4 = 0; i4 < 80; i4++) {
      ...
      const T2 = rotl2(A4, 5) + F4 + E6 + K5 + SHA1_W[i4] | 0;
      E6 = D3;
      D3 = C5;
      C5 = rotl2(B3, 30);
      B3 = A4;
...
var K2 = Array.from({ length: 64 }, (_2, i4) => Math.floor(p32 * Math.abs(Math.sin(i4 + 1))));
...
var MD5 = class extends HashMD2 {
  ...
  get() {
    const { A: A4, B: B3, C: C5, D: D3 } = this;
    return [A4, B3, C5, D3];
  }
  set(A4, B3, C5, D3) {
    this.A = A4 | 0;
...
var shiftsL160 = idxL2.map((idx, i4) => idx.map((j3) => shifts160[i4][j3]));
var shiftsR160 = idxR2.map((idx, i4) => idx.map((j3) => shifts160[i4][j3]));
...
function ripemd_f(group, x3, y7, z3) {
  if (group === 0)
    return x3 ^ y7 ^ z3;
  if (group === 1)
    return x3 & y7 | ~x3 & z3;
...
function split(lst, le4 = false) {
  ...
  for (let i4 = 0; i4 < len; i4++) {
    const { h: h5, l: l5 } = fromBig(lst[i4], le4);
    [Ah[i4], Al[i4]] = [h5, l5];
  }
  return [Ah, Al];
}
var shrSH = (h5, _l, s2) => h5 >>> s2;
var shrSL = (h5, l5, s2) => h5 << 32 - s2 | l5 >>> s2;
var rotrSH = (h5, l5, s2) => h5 >>> s2 | l5 << 32 - s2;
var rotrSL = (h5, l5, s2) => h5 << 32 - s2 | l5 >>> s2;
var rotrBH = (h5, l5, s2) => h5 << 64 - s2 | l5 >>> s2 - 32;
var rotrBL = (h5, l5, s2) => h5 >>> s2 - 32 | l5 << 64 - s2;
...
var SHA3_ROTL = [];
var _SHA3_IOTA = [];
for (let round2 = 0, R4 = _1n2, x3 = 1, y7 = 0; round2 < 24; round2++) {
  [x3, y7] = [y7, (2 * x3 + 3 * y7) % 5];
  SHA3_PI.push(2 * (5 * y7 + x3));
  SHA3_ROTL.push((round2 + 1) * (round2 + 2) / 2 % 64);
  let t2 = _0n2;
  for (let j3 = 0; j3 < 7; j3++) {
    R4 = (R4 << _1n2 ^ (R4 >> _7n) * _0x71n) % _256n;
    if (R4 & _2n)
      t2 ^= _1n2 << (_1n2 << BigInt(j3)) - _1n2;
  }
  _SHA3_IOTA.push(t2);
}
  ...
  for (let round2 = 24 - rounds; round2 < 24; round2++) {
    ...
    for (let y7 = 0; y7 < 50; y7 += 10) {
      for (let x3 = 0; x3 < 10; x3++)
        B3[x3] = s2[y7 + x3];
      for (let x3 = 0; x3 < 10; x3++)
        s2[y7 + x3] ^= ~B3[(x3 + 2) % 10] & B3[(x3 + 4) % 10];
    }
...
var SHA256 = class extends HashMD2 {
  ...
  get() {
    const { A: A4, B: B3, C: C5, D: D3, E: E6, F: F4, G: G3, H: H3 } = this;
    return [A4, B3, C5, D3, E6, F4, G3, H3];
  }
  // prettier-ignore
  set(A4, B3, C5, D3, E6, F4, G3, H3) {
    this.A = A4 | 0;
    this.B = B3 | 0;
    this.C = C5 | 0;
    this.D = D3 | 0;
  ...
  process(view, offset) {
    ...
    let { A: A4, B: B3, C: C5, D: D3, E: E6, F: F4, G: G3, H: H3 } = this;
    for (let i4 = 0; i4 < 64; i4++) {
      const sigma1 = rotr(E6, 6) ^ rotr(E6, 11) ^ rotr(E6, 25);
      const T1 = H3 + sigma1 + Chi(E6, F4, G3) + SHA256_K[i4] + SHA256_W[i4] | 0;
    ...
    G3 = G3 + this.G | 0;
    H3 = H3 + this.H | 0;
    this.set(A4, B3, C5, D3, E6, F4, G3, H3);
  }
  roundClean() {
    clean(SHA256_W);
  }
...
function Ac(t2) {
  ...
  function a2(p3) {
    ...
    return m2 && (N4 = X(N4, O5)), ft("private key", N4, K3, O5), N4;
  }
  function u4(p3) {
  ...
  class h5 {
    ...
    multiplyUnsafe(d3) {
      ...
      for (; $4 > dt || A4 > dt; ) $4 & K3 && (T2 = T2.add(L3)), A4 & K3 && (S4 = S4.add(L3)), L3 = L3.double(), $4 >>= K3, A4 >>= K3;
    ...
    multiplyAndAddUnsafe(d3, v4, m2) {
      const O5 = h5.BASE, N4 = (B3, A4) => A4 === dt || A4 === K3 || !B3.equals(O5) ? B3.multiplyUnsafe(A4) : B3.multiply(A4), $4 = N4(this, v4).add(N4(d3, m2));
    ...
    isTorsionFree() {
      ...
      if (d3 === K3) return true;
      if (v4) return v4(h5, this);
      throw new Error("isTorsionFree() has not been declared for the elliptic curve");
    }
    clearCofactor() {
      const { h: d3, clearCofactor: v4 } = e2;
      return d3 === K3 ? this : v4 ? v4(h5, this) : this.multiplyUnsafe(e2.h);
    }
    toRawBytes(d3 = true) {
...
function Ic(t2) {
  ...
  const { ProjectivePoint: a2, normPrivateKeyToScalar: u4, weierstrassEquation: l5, isWithinCurveOrder: f7 } = Ac({ ...e2, toBytes(g, w2, b4) {
    ...
    if (w2 === o2 && (b4 === 2 || b4 === 3)) {
      const R4 = Ot(I3);
      if (!Ee(R4, K3, n2.ORDER)) throw new Error("Point is not on curve");
      const x3 = l5(R4);
      let C5;
      try {
        C5 = n2.sqrt(x3);
  ...
  function S4(g, w2, b4 = L3) {
    ...
    function st2(W3) {
      ...
      if (Zt3 === dt) return;
      let Ut3 = (zt3.x === vt2 ? 0 : 2) | Number(zt3.y & K3), vn2 = Zt3;
...
function rr2(r2, e2) {
  ...
  function d3(u4) {
    ...
    for (var j3 = (D3 - I3) * l5 + 1 >>> 0, T2 = new Uint8Array(j3); I3 !== D3; ) {
      for (var q3 = u4[I3], J3 = 0, K5 = j3 - 1; (q3 !== 0 || J3 < x3) && K5 !== -1; K5--, J3++) q3 += 256 * T2[K5] >>> 0, T2[K5] = q3 % a2 >>> 0, q3 = q3 / a2 >>> 0;
...
var Ns2 = class extends V {
  constructor(n2) {
    super(n2), c4(this, "name", dt2), c4(this, "events", new import_events4.default()), c4(this, "initialized", false), c4(this, "requestQueue", { state: $2.idle, queue: [] }), c4(this, "sessionRequestQueue", { state: $2.idle, queue: [] }), c4(this, "requestQueueDelay", import_time3.ONE_SECOND), c4(this, "expectedPairingMethodMap", /* @__PURE__ */ new Map()), c4(this, "recentlyDeletedMap", /* @__PURE__ */ new Map()), c4(this, "recentlyDeletedLimit", 200), c4(this, "relayMessageCache", []), c4(this, "pendingSessions", /* @__PURE__ */ new Map()), c4(this, "init", async () => {
      ...
      if (!p3 || !u4) {
        const { topic: T2, uri: K5 } = await this.client.core.pairing.create();
        p3 = T2, h5 = K5;
      }
      if (!p3) {
      ...
      return this.client.events.on("proposal_expire", I3), this.events.once(_2, ({ error: T2, session: K5 }) => {
        this.client.events.off("proposal_expire", I3), T2 ? g(T2) : K5 && A4(K5);
      ...
      const A4 = await this.client.core.crypto.generateKeyPair(), D3 = m2.publicKey, I3 = await this.client.core.crypto.generateSharedKey(A4, D3), T2 = v3(v3(v3({ relay: { protocol: a2 ?? "irn" }, namespaces: l5, controller: { publicKey: A4, metadata: this.client.metadata }, expiry: Ei(J2) }, p3 && { sessionProperties: p3 }), h5 && { scopedProperties: h5 }), u4 && { sessionConfig: u4 }), K5 = Q.relay;
      g.addTrace(er2.subscribing_session_topic);
      try {
        await this.client.core.relayer.subscribe(I3, { transportType: K5 });
      } catch (q3) {
      ...
      try {
        if (i4) {
          ...
          Ie4 = Xc(t2, g, L3);
        } else await Promise.all([this.sendRequest({ topic: g, method: "wc_sessionAuthenticate", params: K5, expiry: e2.expiry, throwOnFailedPublish: true, clientRpcId: te3 }), this.sendRequest({ topic: g, method: "wc_sessionPropose", params: q3, expiry: N2.wc_sessionPropose.req.ttl, throwOnFailedPublish: true, clientRpcId: q3.id })]);
      } catch (x3) {
        throw this.events.off(le4, pe4), this.events.off(Re2, ve3), x3;
      }
      return await this.setProposal(q3.id, q3), await this.setAuthRequest(te3, { request: b2(v3({}, K5), { verifyContext: {} }), pairingTopic: g, transportType: r2 }), { uri: Ie4 ?? A4, response: Rt4 };
  ...
  registerEventListeners() {
    ...
    this.client.on("session_ping", (t2) => {
      ...
      if (a2.name === "accountsChanged") {
        ...
        const r2 = i4.chainId, c5 = i4.event.data, o2 = yo(r2), m2 = K4(r2) !== K4(c5) ? `${o2}:${K4(c5)}` : r2;
...
*/
//# sourceMappingURL=chunk-YA45AQTB.js.map
